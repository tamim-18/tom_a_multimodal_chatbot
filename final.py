...
tts_engine.setProperty('rate', 150)  # You can adjust the speed here
...
def take_screenshot():
    ...
    rgb_im = im.convert('RGB')  # convert to RGB. This avoids the error: "cannot write mode RGBA as JPEG"
    rgb_im.save(path)  # save the image
    im.show()
...
def callback(recognizer, audio):
    ...
    if clean_prompt:
        ...
        print("Please say the wake word followed by your prompt.")
